...
VkPresentModeKHR SwapChain::chooseSwapPresentMode(
  ...
  //for (const auto &availablePresentMode : availablePresentModes) {//There is various present modes - mailbox mode -> GPU never idles
  ...
  //}
   ...
   for (const auto &availablePresentMode : availablePresentModes) {
     if (availablePresentMode == VK_PRESENT_MODE_IMMEDIATE_KHR) { //No synchronisation with the refresh rate of the display
